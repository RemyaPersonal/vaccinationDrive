...
function AddStudent(){
  type ReportRow = {
    ...
    const [searchText, setSearchText] = useState("");
     ...
     const [students, setStudents] = useState<{ name: string; studentid: string ; sclass:string}[]>([]);
    ...
    return(
        <div>
          ...
          {loading && (
            ...
            <h4 className="text-danger">Manage Student <Comment
            visible={true}
            height="40"
            width="40"
            ...
            <div className="content d-flex justify-content-center">
                ...
                {activeSection === "EditStudent" && (
                  <div>
                  <label htmlFor="option" className="h5 text-black-50">Select Student</label>
